...
describe 'murano::keystone::authtoken' do

  let :params do
    { :password => 'murano_password', }
  end

  shared_examples 'murano::keystone::authtoken' do

    context 'with default parameters' do

      it 'configure keystone_authtoken' do
        is_expected.to contain_keystone__resource__authtoken('murano_config').with(
          :username                       => 'murano',
          :password                       => 'murano_password',
  ...
  on_supported_os({
    ...
    context "on #{os}" do
      ...
      it_configures 'murano::keystone::authtoken'
    end
  end
