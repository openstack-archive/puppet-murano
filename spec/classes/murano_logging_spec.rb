...
describe 'murano::logging' do
  ...
  shared_examples_for 'logging params set' do
    it 'enables logging params' do
      is_expected.to contain_oslo__log('murano_config').with(
  ...
  shared_examples_for 'logging params unset' do
   [ :logging_context_format_string, :logging_default_format_string,
     ...
     :log_date_format, ].each { |param|
        it { is_expected.to contain_oslo__log('murano_config').with("#{param}" => '<SERVICE DEFAULT>') }
      }
  end
  ...
  on_supported_os({
    ...
    context "on #{os}" do
      ...
      it_behaves_like 'murano-logging'
    end
  end
