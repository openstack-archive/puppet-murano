...
describe 'murano::keystone::cfapi_authtoken' do

  let :params do
    { :password => 'murano_password', }
  end

  shared_examples 'murano::keystone::cfapi_authtoken' do

    context 'with default parameters' do

      it 'configure keystone_authtoken' do
        is_expected.to contain_keystone__resource__authtoken('murano_cfapi_config').with(
  ...
  on_supported_os({
    ...
    context "on #{os}" do
      ...
      it_configures 'murano::keystone::cfapi_authtoken'
    end
  end
